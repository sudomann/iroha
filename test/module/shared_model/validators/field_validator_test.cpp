...
class FieldValidatorTest : public ValidatorsTest {
 ...
 protected:
  ...
  std::vector<FieldTestCase> amount_test_cases{
      ...
      {"valid_amount_zeroes_in_between",
       [&] { amount = "1000.0001"; },
       true,
       ""},
      {"valid_one_point_zero", [&] { amount = "1.0"; }, true, ""},
      {"invalid_zero_point_zero", [&] { amount = "0.0"; }, false, ""},
      {"valid_zero_point_one", [&] { amount = "0.1"; }, true, ""},
      {"valid_amount_all_numbers", [&] { amount = "1234567890"; }, true, ""},
      {"valid_amount_all_numbers_decimal",
       [&] { amount = "0.0123456789"; },
       true,
       ""},
