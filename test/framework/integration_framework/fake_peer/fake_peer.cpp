...
namespace integration_framework {
  namespace fake_peer {
    ...
    FakePeer::get_proposal_requests_observable() {
      ensureInitialized();
      return od_os_network_notifier_->get_proposal_requests_observable();
    }

    rxcpp::observable<std::shared_ptr<BatchesForRound>>
    FakePeer::get_batches_observable() {
      ensureInitialized();
      return od_os_network_notifier_->get_batches_observable();
    }
